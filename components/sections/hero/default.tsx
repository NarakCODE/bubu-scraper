...
import { ScraperForm } from '@/components/form/scraper-form';
import { ScrapedData } from '@/lib/scraper';
import { toast } from 'sonner';
import { ResultSkeleton } from '@/components/common/result-skeleton';
import { ResultDisplay } from '@/components/common/result-display';
import ActionSearchBar from '@/components/form/action-search-bar';
...
export default function Hero({
  ...
  description = 'Just paste a website URL and get the data you need.',
  // <Screenshot
