    ...
    return (
      ...
      >
        ...
        <video
          ...
          src={src}
          poster={
            'https://cdn.dribbble.com/userupload/23329767/file/original-ffcf3af775c109c59c66dace22cb7fac.png?resize=800x600&vertical=center'
          }
          ...
          <>
            ...
            >
              ...
              <button
                ...
                className="w-16 h-16 rounded-full bg-black/20 backdrop-blur-sm border border-white/30 flex items-center justify-center text-white hover:bg-black/30 transition-all duration-200 pointer-events-auto"
              >
                {isPlaying ? (
